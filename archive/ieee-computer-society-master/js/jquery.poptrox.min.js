...
popupCloserText:"&#215;",popupLoaderText:"&bull;&bull;&bull;&bull;",popupClass:"poptrox-popup skel-panels-fixed",popupSelector:null,popupLoaderSelector:".loader",popupCloserSelector:".closer",popupCaptionSelector:".caption",popupNavPreviousSelector:".nav-previous",popupNavNextSelector:".nav-next",onPopupClose:null,onPopupOpen:null},v);v=d(this);var F=d("body"),h=d("<div></div>"),A=d(window),z,w,x=[],t=0,m=!1,H=[],G=(n=navigator.userAgent.match(/MSIE ([0-9]+)\./)&&6==RegExp.$1)?"absolute":"fixed";a.usePopupLoader||
